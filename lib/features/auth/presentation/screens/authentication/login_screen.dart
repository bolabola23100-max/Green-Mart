...
import 'package:green_mart/features/auth/presentation/screens/authentication/signup_screen.dart';
...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: BodyLogin(formKey: formKey));
  }
}

class BodyLogin extends StatelessWidget {
  const BodyLogin({super.key, required this.formKey});
